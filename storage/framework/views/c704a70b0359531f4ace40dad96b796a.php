<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('Обновить пароль')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Убедитесь, что ваш аккаунт использует длинный, случайный пароль для обеспечения безопасности.')); ?>
...
<?php /**PATH D:\diplom\proj\diplom\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>