<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('Информация профиля')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__("Обновите информацию профиля и адрес электронной почты вашего аккаунта.")); ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        <?php echo e(__('Ваш адрес электронной почты не подтвержден.')); ?>
                    ...
                    <?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm text-green-600">
                            <?php echo e(__('Новая ссылка для подтверждения была отправлена на ваш адрес электронной почты.')); ?>
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                ...
                ><?php echo e(__('Сохранено.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH D:\diplom\proj\diplom\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>